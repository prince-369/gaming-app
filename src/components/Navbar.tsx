      ...
      >
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-2">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            {/* Logo with outer ring effect */}
            <div className="logo-outer-ring rounded-xl p-0.5">
              <div className="logo-container flex h-10 w-10 items-center justify-center rounded-xl">
                <div className="relative">
                  <span className="text-lg">🎮</span>
                  <div className="absolute -inset-2 bg-gradient-to-r from-[#ff073a] to-[#00f0ff] blur opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                </div>
              </div>
            </div>
